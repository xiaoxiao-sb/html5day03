...
module.exports = function(environment) {
    var Quoted = require('../tree/quoted'),
        ...
        fallback = function(functionThis, node) {
            return new URL(node, functionThis.index1, functionThis.currentFileInfo).eval(functionThis.context);
        },
    ...
    functionRegistry.add('data-uri', function(mimetypeNode, filePathNode) {
        ...
        return new URL(new Quoted('"' + uri + '"', uri, false, this.index1, this.currentFileInfo), this.index1, this.currentFileInfo);
    });
};
        ...
        for (var i = 0; i < iterator.length; i++) {
            ...
            if (valueName) {
                newRules.push(new Declaration(valueName,
                    value,
                    false, false, this.index1, this.currentFileInfo));
            }
            if (indexName) {
...
module.exports = function(environment) {
    ...
    functionRegistry.add('svg-gradient', function(direction) {
        ...
        return new URL(new Quoted('\'' + returner + '\'', returner, false, this.index1, this.currentFileInfo), this.index1, this.currentFileInfo);
    });
};
...
var LessError = module.exports = function LessError(e, fileContentMap, currentFilename) {
    ...
    if (fileContentMap && filename) {
        var input = fileContentMap.contents[filename],
            loc = utils.getLocation(e.index1, input),
            line = loc.line,
            col  = loc.column,
        ...
        parsers: parsers = {
            ...
            comment: function () {
                if (parserInput.commentStore.length) {
                    ...
                    return new(tree.Comment)(comment.text, comment.isLineComment, comment.index1, fileInfo);
                }
            },
...
ProcessExtendsVisitor.prototype = {
    ...
    checkExtendsForNonMatched: function(extendList) {
        ...
        extendList.filter(function(extend) {
            ...
            if (!indices[extend.index1 + ' ' + selector]) {
                indices[extend.index1 + ' ' + selector] = true;
    ...
    extendSelector:function (matches, selectorPath, replacementSelector, isVisible) {
        ...
        for (matchIndex = 0; matchIndex < matches.length; matchIndex++) {
            ...
            newElements = selector.elements
                .slice(currentSelectorPathElementIndex, match.index1)
                .concat([firstElement])
